...
const Features2 = () => {
  return (
    <div className='w-full h-[300px] mt-16 grid grid-cols-2 overflow-hidden'>
        <div className='w-full h-[300px] relative'>
            ...
            <div className='w-full absolute h-full flex flex-col justify-center items-end p-5 inset-0 bg-black/10'>
                <h1 className='text-5xl text-white font-karla font-bold'>Lorem, ipsum.</h1>
                <button className='px-3 py-2 text-2xl mt-3 bg-white w-[100px] rounded-tr-2xl rounded-bl-2xl flex items-center
