...
const ShopByCategory = () => {
  return (
    <div className='w-full h-full mt-10'>
        ...
        <div className='w-full sm:h-[600px] mt-10 sm:flex gap-2 px-2'>
            <div className='w-full h-[350px] sm:h-full md:w-[700px] xl:w-[850px] bg-white relative'>
                ...
                <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
                    ...
                    <p className='text-sm font-poppins text-white sm:w-[80%]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium quibusdam optio doloremque enim cupiditate ab reiciendis repellat amet obcaecati facere.</p>
            ...
            <div className='w-full h-[340px] sm:h-full sm:w-[400px] md:w-[350px] relative sm:mt-0 mt-2'>
                ...
                <div className='absolute bottom-0 left-0 bg-black/20 p-3 w-full'>
            ...
            <div className='w-[700px] h-full hidden lg:grid grid-cols-2 gap-2'>
                <div className='w-full h-full relative overflow-hidden'>
                    <img src="https://i.pinimg.com/736x/c5/0f/4b/c50f4b27bed130f64cb4bf2258895514.jpg" className='w-full h-[350px] object-cover' alt="" />
                    <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
                ...
                <div className='w-full h-full relative overflow-hidden'>
                    <img src="https://media.istockphoto.com/id/487402642/photo/fresh-juice.jpg?s=612x612&w=0&k=20&c=hjrPG05Pks54_dTutZEd31GIqua9LCG5-sOHMBHq-DA=" className='w-full h-[350px] object-cover' alt="" />
                    <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
                ...
                <div className='w-full h-full relative overflow-hidden'>
                    <img src="https://thumbs.dreamstime.com/b/stylish-colorful-background-different-cosmetics-products-digital-artwork-ai-generated-stylish-colorful-background-341060299.jpg" className='w-full h-[350px] object-cover' alt="" />
                    <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
                ...
                <div className='w-full h-full relative overflow-hidden'>
                    <img src="https://media.istockphoto.com/id/585591088/photo/energy-saving-led-lamp-and-several-old-light-bulbs.jpg?s=612x612&w=0&k=20&c=DVYEscQDo-lL9Jy7-tdEg3JfA9mwDSRpD6FcFPoBhwY=" className='w-full h-[350px] object-cover' alt="" />
                    <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
        ...
        <div className='w-full px-2 mt-2 h-full grid lg:hidden sm:grid-cols-2 gap-2'>
                <div className='w-full h-full relative overflow-hidden'>
                    <img src="https://i.pinimg.com/736x/c5/0f/4b/c50f4b27bed130f64cb4bf2258895514.jpg" className='w-full h-[350px] object-cover' alt="" />
                    <div className='absolute bottom-0 left-0 bg-black/20 p-3'>
                        <h1 className='text-4xl font-overpass text-white font-bold'>Meat</h1>
